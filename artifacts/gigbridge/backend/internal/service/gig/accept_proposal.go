...
func (h *Handler) AcceptProposal(c *gin.Context) {
	...
	if _, err = authz.Check(authz.CheckRequest{Action: "AcceptProposal", Resource: "gig", ResourceID: gig.ClientID, Role: currentUser.Role, UserID: currentUser.ID}); err != nil {
