...
func (h *Handler) SubmitProposal(c *gin.Context) {
	...
	if _, err = authz.Check(authz.CheckRequest{Action: "SubmitProposal", Resource: "gig", ResourceID: gig.ClientID, Role: currentUser.Role, UserID: currentUser.ID}); err != nil {
