// fullend:gen ssot=frontend/gigs.html contract=520a27c
    ...
    <div>
      ...
      {listGigsData && (
        <section>
          ...
          {listGigsDataLoading && <div>Loading...</div>}
          {listGigsData.ListGigs?.length === 0 && <div>No gigs found.</div>}
          <ul>
